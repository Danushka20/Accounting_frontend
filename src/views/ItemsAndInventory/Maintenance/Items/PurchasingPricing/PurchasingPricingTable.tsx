...
function PurchasingPricingTable() {
    ...
    useEffect(() => {
        const dummyData: PurchasingPricing[] = [
            { id: 1, currency: "USD", purchaseType: "Retail", price: 50 },
            { id: 2, currency: "USD", purchaseType: "Wholesale", price: 45 },
            { id: 3, currency: "EUR", purchaseType: "Retail", price: 55 },
            { id: 4, currency: "EUR", purchaseType: "Wholesale", price: 50 },
            { id: 5, currency: "LKR", purchaseType: "Retail", price: 12000 },
            { id: 6, currency: "LKR", purchaseType: "Wholesale", price: 11000 },
        ];
    ...
    const filteredData = useMemo(() => {
        return purchaseData.filter((item) => {
            return (
                item.purchaseType.toLowerCase().includes(searchQuery.toLowerCase()) ||
            ...
            >
                ...
                <Stack direction="row" spacing={1}>
                    <Button
                        variant="contained"
                        color="primary"
                        onClick={() => navigate("/itemsandinventory/maintenance/items/add-purchasing-pricing")}
                    >
            ...
            >
                <Box sx={{ width: isMobile ? "100%" : "300px" }}>
                    <SearchBar
                        ...
                        placeholder="Search Purchase Type or Price..."
                    />
                </Box>
            </Stack>
                                        ...
                                        <TableCell align="center">
                                            <Stack direction="row" spacing={1} justifyContent="center">
                                                <Button
                                                    ...
                                                    size="small"
                                                    startIcon={<EditIcon />}
                                                    onClick={() => navigate(`/itemsandinventory/maintenance/items/update-purchasing-pricing/${item.id}`)}
                                                >
                                                    Edit
                                                </Button>
                                                <Button
